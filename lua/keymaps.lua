...
km({ "n" }, "<leader>;", ":Alpha<cr>", { desc = "Dashboard" })
...
mkm("telescope", { "n" }, "<leader>tH", ":Telescope highlights<cr>", { desc = "highlights" })
mkm("telescope", { "n" }, "<leader>te", ":Telescope file_browser<cr>", { desc = "File Browser" })
