...
--> Dep (Package Manager) <--
mkm("dep", { "n" }, "<leader>d", "Dep", { desc = "Package Manager" })
mkm("dep", { "n" }, "<leader>ds", ":DepSync<cr>", { desc = "Sync" })
mkm("dep", { "n" }, "<leader>dl", ":DepList<cr>", { desc = "List" })
mkm("dep", { "n" }, "<leader>dr", ":DepReload<cr>", { desc = "Reload" })
mkm("dep", { "n" }, "<leader>dc", ":DepClean<cr>", { desc = "Clean" })
mkm("dep", { "n" }, "<leader>dC", ":DepConfig<cr>", { desc = "Config" })
mkm("dep", { "n" }, "<leader>dL", ":DepLog<cr>", { desc = "Log" })
--> buffers <--
