local M = {}
local system = require("modules.global.conf.system")
local ui = require("modules.global.conf.ui")
local editor = require("modules.global.conf.editor")
local git = require("modules.global.conf.vcs")
local langs = require("modules.global.conf.langs")
local completion = require("modules.global.conf.completion")
...
--   -- config = [[vim.cmd("colorscheme monochrome")]]
-- }
