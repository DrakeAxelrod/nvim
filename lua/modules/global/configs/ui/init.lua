...
function config.lvim_helper()
	...
	require("lvim-helper").setup({
		files = {
			...
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_visual_commands.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_insert_mode.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_editing.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_registers.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_marks_and_positions.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_macros.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_cut_and_paste.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_indent_text.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_exiting.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_search_and_replace.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_search_in_multiple_files.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_tabs.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_working_with_multiple_files.md",
			vim.fn.stdpath("config") .. "/help/vim_cheat_sheet_diff.md",
		},
	})
end
