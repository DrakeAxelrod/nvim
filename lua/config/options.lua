...
M.defaults = function()
  ...
  vim.opt.directory = path.join(vim.fn.stdpath("cache"), "swag")
  vim.opt.undodir = path.join(vim.fn.stdpath("cache"), "undo")
  vim.opt.backupdir = path.join(vim.fn.stdpath("cache"), "backup")
  vim.opt.viewdir = path.join(vim.fn.stdpath("cache"), "view")
  -- vim.opt.spellfile = path.join(vim.fn.stdpath("cache"), "/spell/en.uft-8.add")
  vim.opt.shadafile = path.join(vim.fn.stdpath("cache"), "shada")
