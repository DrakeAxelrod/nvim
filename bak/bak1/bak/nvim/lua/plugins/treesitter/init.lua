...
local comment = require("plugins.treesitter.comment")
local colorizer = require("plugins.treesitter.colorizer")

local after = {
  { "p00f/nvim-ts-rainbow" },
  { "JoosepAlviste/nvim-ts-context-commentstring", dep = { comment } },
  colorizer,
}
